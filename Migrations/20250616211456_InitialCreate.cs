...
namespace EHRsystem.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PharmacyName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PharmacyLocation = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PharmacyRecommendations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PharmacyRecommendations_Prescriptions_PrescriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PharmacyRecommendations_PrescriptionId",
                table: "PharmacyRecommendations",
